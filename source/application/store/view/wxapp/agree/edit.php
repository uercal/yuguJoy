                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">编辑用户协议</div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <!-- 加载编辑器的容器 -->
                                    <textarea id="container" name="agree[content]" type="text/plain"><?= $model['content'] ?></textarea>
                                </div>
                            </div>
                            <input type="hidden" name="agree[id]" value="<?= $model['id'] ?>">
                            <div class="am-form-group">
