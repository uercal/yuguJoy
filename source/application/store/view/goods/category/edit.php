                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="category[is_index]" value="10" data-am-ucheck
                                            <?= $model['is_index'] === 10 ? 'checked' : '' ?> >
                                        是
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="category[is_index]" value="20" data-am-ucheck
                                            <?= $model['is_index'] === 20 ? 'checked' : '' ?> >
                                        否
                                    </label>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="category[type]" value="10" data-am-ucheck
