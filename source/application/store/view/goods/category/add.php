                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">添加服务分类</div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="category[is_index]" value="10" data-am-ucheck checked
                                            >
                                        是
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="category[is_index]" value="20" data-am-ucheck
                                        >
                                        否
                                    </label>
                                </div>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">显示类型 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="category[type]" value="10" data-am-ucheck checked
                                            >
                                            两大块(该分类下 服务图标建议宽高比例为 1.7:1 )
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="category[type]" value="20" data-am-ucheck
                                        >
                                        四小块(该分类下 服务图标建议为等宽高[正方形])
                                    </label>
                                </div>
                            </div>
                            <div class="am-form-group">
