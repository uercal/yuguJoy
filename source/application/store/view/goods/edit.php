                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="goods-spec-single"
                                ...
                                <!-- <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label">服务编码 </label>
                                    <div class="am-u-sm-9 am-u-end">
                                ...
                                <!-- <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label">服务划线价 </label>
                                    <div class="am-u-sm-9 am-u-end">
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">服务重量(Kg) </label>
                                    <div class="am-u-sm-9 am-u-end">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="goods[bonus_text]"
                                           value="<?= $model['bonus_text'] ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
