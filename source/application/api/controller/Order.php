...
class Order extends Controller
{
     ...
     * @throws \Exception
     */
    public function buyNow($goods_id,$spec,$address_id,$server_time)
    {
        // 商品结算信息
        ...
        // 服务时间
        $year = date('Y年',time());
        $arr = date_parse_from_format('Y年m月d日 H:i',$year.$server_time);
        $server_time = mktime(0,0,0,$arr['month'],$arr['day'],$arr['year']);
        ...
        $order = $model->getBuyNow($this->user, $goods_id, $post_data);
